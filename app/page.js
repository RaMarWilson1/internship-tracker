  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const offers = apps.filter(
        (a) =>
          a.application_status === 'Offer' ||
          a.application_status === 'Accepted'
      ).length;
      const pending = apps.filter((a) => a.application_status === 'Applied')
        .length;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="font-semibold text-gray-900">Ranking Statement</h3>
                    <p className="text-sm text-gray-600">View team contributions</p>
                  </div>
                </div>
              </Link>
            </div>
